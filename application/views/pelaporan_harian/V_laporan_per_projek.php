        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="progress" style="height: 25px;">
                    <div class="progress-bar prg-projek" role="progressbar" style="width: 40%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"> <span id="t_progress_posisi" style="font-size: 15px"></span></div>
                </div>
            </div>
        </div>

        <div class="card mt-3">
            <div class="card-header bg-warning text-white p-3"><h5 id="judul" class="font-weight-bold">Tim Projek</h5></div>
            <div class="card-body table-responsive">
        ...
        // 14-04-2020
            ...
            $('.tabel_list_tim').on('click', '.lihat-laporan',function () {
                ...
                $.ajax({
                    ...
                    type    : "POST",
                    data    : {id_pegawai:id_pegawai,id_data_projek:id_data_projek, nama_pegawai:nama_pegawai, id_tim_projek:id_tim_projek, id_posisi:id_posisi},
                    success : function (data) {
